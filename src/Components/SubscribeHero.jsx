...
function SubscribeNav() {
  return (
    <section className='bg-'>
        <div className='container bg-[#f9f9ff] flex items-center justify-center relative overflow-hidden'>
            <div className='flex flex-col gap-4 pt-20 pb-32 px-64'>
            ...
            <div className='w-96 h-96 rounded-full bg-[#CDE5FF] absolute opacity-50 blur-3xl -bottom-32 -left-28'></div>
                <h2 className='text-[#121C2A] font-playFair font-bold text-[55px]'>Elevate Your Culinary Journey</h2>
