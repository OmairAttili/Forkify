...
seared sea bass to classic fish tacos.</p>
                <div className='pt-3 flex flex-col sm:flex-row sm:items-center gap-4'>
                    <button type='button' className='bg-[#9D4300] font-semibold text-sm px-8 py-4 rounded-full cursor-pointer text-white flex items-center gap-2 hover:bg-[#9D4300]/70 hover:scale-105 transition-all duration-300 hover:translate-y-2 justify-center'>
                        <span>Browse All Recipes</span>
                    </button>
                    <button type='button' className='bg-white/10 font-semibold text-sm px-8 py-4 rounded-full cursor-pointer text-white flex items-center gap-2 hover:bg-white/50 hover:scale-105 transition-all duration-300 hover:translate-y-2 backdrop-blur-3xl border border-white/20 justify-center'>
                        <span>Browse All Recipes</span>
                    </button>
                </div>
            </div>
