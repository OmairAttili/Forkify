            ...
            <div className='flex flex-col items-center justify-center gap-12'>
                ...
                <div className='flex flex-wrap md:flex-nowrap items-center gap-12 w-full'>
                    <div className='flex flex-col items-center justify-center w-full'>
                        <img src='./src/assets/Chef portrait.png' alt='Chef' className='rounded-full'/>
                    ...
                    <div className='flex flex-col items-center justify-center w-full'>
                        <img src='./src/assets/Chef portrait (2).png' alt='Chef' className='rounded-full'/>
                    ...
                    <div className='flex flex-col items-center justify-center w-full'>
                        <img src='./src/assets/Chef portrait (3).png' alt='Chef' className='rounded-full'/>
